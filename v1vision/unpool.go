...
// func UnPool(psize, spc math32.Vector2i, in, out *tensor.Float32, rnd bool) {
// 	ny := in.DimSize(0)
// 	nx := in.DimSize(1)
// 	pol := in.DimSize(2)
// 	nang := in.DimSize(3)
...
// func unPoolThr(wg *sync.WaitGroup, fno, nf int, psize, spc math32.Vector2i, in, out *tensor.Float32, rnd bool) {
// 	ny := out.DimSize(0)
// 	nx := out.DimSize(1)
// 	nang := out.DimSize(3)
// 	psz := psize.X * psize.Y
