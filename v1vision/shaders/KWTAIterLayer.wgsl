...
fn KWTAIterLayer(i: u32) { //gosl:kernel
	...
	geAvg /= ln;
	actAvg /= ln;
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(GeAvg))] = geAvg;
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(GeMax))] = geMax;
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(ActAvg))] = actAvg;
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(ActMax))] = actMax;
	var fbi = Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(FBi))];
	...
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(FFi))] = ffi;
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(FBi))] = fbi;
	var gi = kp.Layer.Gi * (ffi + fbi);
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52], TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(Gi))] = gi;
	Inhibs[Index4D(TensorStrides[50], TensorStrides[51], TensorStrides[52],
	TensorStrides[53], u32(op.Inhibs), u32(lyi), u32(0), u32(GiOrig))] = gi;
}
