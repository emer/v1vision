...
// func MaxPool(psize, spc math32.Vector2i, in, out *tensor.Float32) {
// 	ny := in.DimSize(0)
// 	nx := in.DimSize(1)
// 	pol := in.DimSize(2)
// 	nang := in.DimSize(3)
...
// func maxPoolThr(wg *sync.WaitGroup, fno, nf int, psize, spc math32.Vector2i, in, out *tensor.Float32) {
// 	ny := out.DimSize(0)
// 	nx := out.DimSize(1)
// 	nang := out.DimSize(3)
// 	for fi := 0; fi < nf; fi++ {
